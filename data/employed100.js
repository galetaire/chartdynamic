...
function makeChart(employed100) {
  ...
  var rangeOne = employed100.map(function(d) {return d.Inflation_CPI}).slice(rangeStart, rangeEnd);
  var rangeTwo = employed100.map(function(d) {return d.Workers_per_100_inhab}).slice(rangeStart, rangeEnd);
